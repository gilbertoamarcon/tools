...
sudo apt-get -y install python-joblib
...
sudo -H pip install bunch
sudo -H pip install bunchify
sudo -H pip install cython
sudo -H pip install deepdish
...
sudo -H pip install gsw
sudo -H pip install h5py
sudo -H pip install haversine
sudo -H pip install Image
sudo -H pip install pycuda
sudo -H pip install mako
sudo -H pip install joblib
sudo -H pip install sympy
sudo -H pip install keras
sudo -H pip install lark
sudo -H pip install lark_parser
